                        ...
                        <form method="POST" class="row g-4" action="{{ route('register') }}">
                            ...
                            <div class="col-12">
                                <div class="form-check"> 
                                    ...
                                    <label class="form-check-label">I agree and accept the terms and conditions</label>
                                </div>
                            </div>
                            <div class="col-12"> <button class="btn btn-primary w-100" type="submit">Register</button></div>
                            <div class="col-12">
